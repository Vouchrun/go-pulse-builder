...
type generateParams struct {
	...
	gasLimit    uint64            // Optional explicit gas limit (builder mode); 0 = derive from config
...
func (miner *Miner) prepareWork(genParams *generateParams, witness bool) (*environment, error) {
	...
	// Builder mode may pin the gas limit from the payload attributes
	// (derived from the validator's registered gas limit).
	if genParams.gasLimit != 0 {
